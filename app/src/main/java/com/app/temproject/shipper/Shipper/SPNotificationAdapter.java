...
import com.app.temproject.shipper.Store.STDetailRequestActivity;
...
public class SPNotificationAdapter extends RecyclerView.Adapter<SPNotificationAdapter.MyViewHolder> {
    ...
    public SPNotificationAdapter(Activity activity, List<Notification> notifications) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.sp_notification_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        switch (notification.getCode()){
            case Notification.STORE_ACCEPT_SHIPPER_NOTIFICATION_CODE:
                holder.ivNotificationType.setImageResource(R.drawable.accepted_notification);
                break;
            case Notification.STORE_CONFIRM_COMPLETED_REQUEST_NOTIFICATION_CODE:
                holder.ivNotificationType.setImageResource(R.drawable.completed_notification);
                break;
            case Notification.STORE_CANCEL_ACCEPTED_REQUEST_NOTIFICATION_CODE:
                holder.ivNotificationType.setImageResource(R.drawable.delete_notification);
                break;
            case Notification.STORE_ACCEPT_ANOTHER_SHIPPER_NOTIFICATION_CODE:
                holder.ivNotificationType.setImageResource(R.drawable.delete_notification);
                break;
            default:
                break;
